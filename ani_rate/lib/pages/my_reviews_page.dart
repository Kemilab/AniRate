...
class MyReviewsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Reviews',style: TextStyle(color: Color.fromARGB(255, 252, 131, 50)),),
        backgroundColor: const Color.fromRGBO(35, 35, 35, 1),
        iconTheme: const IconThemeData(color: Color.fromARGB(255, 252, 131, 50)),
      ),
      body: user != null
          ? Stack(
              children: [
                ...
                Container(
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      color: Colors.black.withOpacity(0), // Transparent color to apply the blur
                    ),
                  ),
                ),
                // Foreground content
